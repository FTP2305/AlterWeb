...
<body>
    <header class="navbar">
        <div class="navbar-container">
            ...
            <nav>
                <ul class="nav-links">
                    <li><a href="../Home.php">Inicio (Tienda)</a></li> <li><a href="../Productos/listar.php">Productos</a></li>
                    <li><a href="historial.php">Ventas</a></li> <li><a href="../intranet.php?logout=true">Cerrar Sesión <i class="fas fa-sign-out-alt"></i></a></li>
                </ul>
            </nav>
        </div>
    </header>
